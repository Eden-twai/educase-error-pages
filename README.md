...
4. 503 頁面的預定維護時間已更新為實際時段。
5. Header、Footer、SVG icon、維護時間區塊與按鈕在桌機及手機尺寸下顯示正常。
6. 「回到首頁」可正確連至 `https://educase.kh.edu.tw/welcome/`。
7. 維護結束後，503 設定已移除並恢復正常頁面與 HTTP Status。

## 建議 Commit

```text
feat(error-pages): 優化 503 維護頁視覺並新增預定維護時間
```
